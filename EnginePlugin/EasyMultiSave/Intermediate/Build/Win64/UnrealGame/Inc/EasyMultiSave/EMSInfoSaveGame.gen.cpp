...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEMSInfoSaveGame_Statics::NewProp_SlotInfo = { "SlotInfo", nullptr, (EPropertyFlags)0x0010000001000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEMSInfoSaveGame, SlotInfo), Z_Construct_UScriptStruct_FSaveSlotInfo, METADATA_PARAMS(Z_Construct_UClass_UEMSInfoSaveGame_Statics::NewProp_SlotInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEMSInfoSaveGame_Statics::NewProp_SlotInfo_MetaData)) }; // 2022892725
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Public_EMSInfoSaveGame_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Public_EMSInfoSaveGame_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEMSInfoSaveGame, UEMSInfoSaveGame::StaticClass, TEXT("UEMSInfoSaveGame"), &Z_Registration_Info_UClass_UEMSInfoSaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEMSInfoSaveGame), 1912803472U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Public_EMSInfoSaveGame_h_3002217323(TEXT("/Script/EasyMultiSave"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Public_EMSInfoSaveGame_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_EasyMultiSave_Source_EasyMultiSave_Public_EMSInfoSaveGame_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
